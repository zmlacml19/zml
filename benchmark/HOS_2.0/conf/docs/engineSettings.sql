...
--set spark.home=/opt/spark-1.6.2;
--set spark.home=/home/zly/spark-2.0.0-bin-hadoop2-without-hive/;
--set spark.home=/home/HOS/HOS20/spark-2.0.0-bin-hadoop2-without-hive/;
set spark.home=/root/HOS_workspace/HOS_2.0/softwares/spark-2.0.0-bin-hadoop2-without-hive;
...
set spark.yarn.executor.memoryOverhead=1966;
--set spark.executor.cores=8;
